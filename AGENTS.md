...
- Keep tool paths compatible with the documented checkout path:
  `~/ai-berkshire/tools/...`
- This `AGENTS.md` is the single instruction file for both Claude Code and
  Codex behavior (the former `CLAUDE.md` was merged into it).
...
| /news-pulse | `{公司名}-news-{YYYYMMDD}.md` | `reports/宁德时代/宁德时代-news-20260912.md` |
