...
This skill is generated from `skills/bottleneck-hunter.md` so Claude Code, Codex and other harnesses share one canonical workflow.
...
9. **遵循AGENTS.md客观性原则** — 不预设看多，先数据后结论
